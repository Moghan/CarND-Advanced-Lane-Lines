...
# # calculate curve radius
    y_eval = np.max(ploty)
#     # print('leftfit_y: %i, leftfit_x: %i' % (left_fit[0], left_fit[1]))
...
#     curve_rad = (left_curverad + right_curverad) / 2
    ...
    get_curverad_meters(ploty, left_line.recent_xfitted[0])
    get_curverad_meters(ploty, right_line.recent_xfitted[0])
...
# -----------------------------
    ...
    right_line.line_base_pos = (right_fitx[-1] - image_center) * xm_per_pix
    left_line.line_base_pos = (left_fitx[-1] - image_center) * xm_per_pix
...
def _image_pipeline(image):
    ...
    gradx_binary = abs_sobel_thresh(warped_image, orient='x', sobel_kernel=ksize, thresh=(20, 200))
    s_binary = s_channel_thresh(warped_image, s_thresh = (78,255))
...
def image_pipeline(image):
    ...
    center_dist = right_line.line_base_pos - left_line.line_base_pos
